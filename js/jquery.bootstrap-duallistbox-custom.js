  ...
  BootstrapDualListbox.prototype = {
    ...
    setBootstrap2Compatible: function(value, refresh) {
      ...
      if (value) {
        ...
        this.container.find('.moveall > i').removeClass('icon-arrow-right').addClass('addAll');
        this.container.find('.move > i').removeClass('icon-arrow-right').addClass('addSelected');
        this.container.find('i:nth-child(2)').remove();
        this.container.find('.remove > i').removeClass('icon-arrow-left').addClass('removeSelected');
        this.container.find('.removeall > i').removeClass('icon-arrow-left').addClass('removeAll');
      }
      if (refresh) {
        refreshSelects(this);
      }
...
// New Code
  // $('.moveall > i:nth-child(2)').addClass('addSelected');
